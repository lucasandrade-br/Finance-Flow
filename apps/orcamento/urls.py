...
from apps.orcamento.views import (
    ...
    lancar_movimentacao_orcamento_futuro,
...
urlpatterns = [
    ...
    path('planejamento/movimentacoes/<int:registro_id>/lancar/', lancar_movimentacao_orcamento_futuro, name='lancar_movimentacao_orcamento_futuro'),
